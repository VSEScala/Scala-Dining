...
class SelectWithDisabled(django.forms.Select):
    ...
    modified or considered, these disabled options are simply added afterwards.
    """
    ...
    def __init__(self, disabled_choices=(), *args, **kwargs):
        ...
        Args:
            disabled_choices: Indicates the disabled choices that must be
                shown. This parameter must be formatted like the choices
                parameter, i.e. a list or tuple of tuple pairs with
