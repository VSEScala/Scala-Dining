...
urlpatterns = [
    ...
    path('members/validate/<int:id>', views_association.MembersOverview.as_view(), name='association_members'),
    path('members/remove/<int:id>', views_association.MembersOverview.as_view(), name='association_members')
]
