...
from CreditManagement.views import TransactionAssociationView
...
urlpatterns = [
    path('association/<slug:association_name>/', include([
        ...
        path('transactions/transfer/', TransactionAssociationView.as_view(), name='association_transaction'),
